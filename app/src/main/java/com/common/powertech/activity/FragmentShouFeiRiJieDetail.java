...
public class FragmentShouFeiRiJieDetail extends Fragment {
    ...
    private Boolean ifDetail = false;
    // 设置下拉刷新
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(getArguments()!=null && (Integer)getArguments().getInt("tof_pageno")!=null){
        	mCurrentPage = getArguments().getInt("tof_pageno");
        	ifZaitu = getArguments().getBoolean("tof_status");
        }
    ...
    private ArrayList<HashMap<String, Object>> BD_getDate() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (ifZaitu) {
                ...
                map.put("btn", getString(R.string.str_caozuo));
            }
            listItem.add(map);
        }
//        //多加一行 用于显示 上一页 下一页按钮
...
//        listItem.add(map);
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (ifZaitu) {
                            ...
                            String ticket = Client.Parse_XML(temp, "<TICKET>", "</TICKET>");
                            Operation("<TICKET>" + ticket + "</TICKET>",position);
                            //PrintNotice("<TICKET>" + ticket + "</TICKET>");
    ...
    private void Operation(final String ticket,final int position){
    	new AlertDialog.Builder(mActivity).setTitle(getString(R.string.main_daozhangqueren_listtv_caozuo))
		        ...
		        .setPositiveButton(getString(R.string.str_dayin), new DialogInterface.OnClickListener() {//添加确定按钮
		        ...
		        }).setNegativeButton(getString(R.string.str_detail), new DialogInterface.OnClickListener() {//添加返回按钮
				    @Override
				    public void onClick(DialogInterface dialog, int which) {//响应事件
		                ...
		                FragmentShouFeiRiJie_Detail daozhangqueren = new FragmentShouFeiRiJie_Detail();
		                Bundle bundle = new Bundle();
                        bundle.putString("tofno", list.get(position).Get_TOF_NO());
                        bundle.putString("tof_ticket", ticket);
                        bundle.putInt("tof_pageno", mCurrentPage);
                        bundle.putBoolean("tof_status", ifZaitu);
		                ...
		                //读取操作员
		                Request_Daily_Query.setOperID(GlobalParams.LOGIN_USER_ID);
		                Request_Daily_Query.setStatue("2");
		                Request_Daily_Query.setPagenum("1");
		                mCurrentPage = 1;
//		                Request_Daily_Query.setNumperpage("5");
